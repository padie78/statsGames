...
export const DASHBOARD_QUICK_ACTIONS = [
  ...
  },
  {
    id: 'ai',
    label: 'AI Coach',
    hint: 'Plan post-partida',
    body: 'Te dice qué practicar según tus últimos matches — no un muro de stats crudas.',
    route: '/tabs/ai-coach',
    icon: 'coach' as const,
    tone: 'pink' as const,
    badge: 'IA',
  ...
  },
  {
    id: 'integrations',
    label: 'Conectar',
    hint: 'Riot · Steam · Epic',
    body: 'Vinculá cuentas para que el poller traiga partidas nuevas sin trabajo manual.',
